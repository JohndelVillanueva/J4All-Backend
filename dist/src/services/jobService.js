...
export class JobService {
     ...
     */
    static async createJob(data, employerId) {
        try {
    ...
    static async getAllJobs(params = {}) {
        try {
            const { page = 1, limit = 10, keyword, location, job_type, work_mode, min_salary, max_salary, sortBy = 'posted_date', sortOrder = 'desc', } = params;
     ...
     */
    static async updateJob(jobId, data, employerId) {
        try {
            ...
            if (data.job_requirements)
                updateData.job_requirements = data.job_requirements;
            ...
            if (data.salary_range_min)
                updateData.salary_range_min = data.salary_range_min;
            if (data.salary_range_max)
                updateData.salary_range_max = data.salary_range_max;
