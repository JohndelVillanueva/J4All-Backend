...
export const scheduleInterviewController = async (c) => {
    try {
        ...
        try {
            ...
            if (jobSeeker) {
                ...
                if (user) {
                    ...
                    await emailService.sendVerificationEmail(email, userName, 'interview-scheduled-token' // Not used, but required by the method signature
                    );
                }
