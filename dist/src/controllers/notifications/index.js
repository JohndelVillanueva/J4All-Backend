...
export const getNotificationsController = async (c) => {
    try {
...
export const getUnreadNotificationCountController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const createNotificationController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const markNotificationAsReadController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const markAllNotificationsAsReadController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const deleteNotificationController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
