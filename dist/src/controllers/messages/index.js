...
export const getConversationsController = async (c) => {
    try {
...
export const getMessagesController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const createConversationController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const getUnreadMessageCountController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
...
export const getConversationDetailsController = async (c) => {
    try {
        const user = c.get("user") || {
            id: c.get("userId"),
            userType: c.get("userType"),
