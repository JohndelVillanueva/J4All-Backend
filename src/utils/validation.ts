...
export const createJobPostingSchema: ValidationSchema = {
...
export const jobApplicationSchema: ValidationSchema = {
...
export const createConversationSchema: ValidationSchema = {
  participant2_id: { type: 'number', required: true, min: 1 }
};

// Validation function (basic implementation)
export const validate = (data: any, schema: ValidationSchema): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
